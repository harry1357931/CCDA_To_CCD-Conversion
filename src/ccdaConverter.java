...
/* Class ccdaConverter
 * Performs Conversion from CCDA file(XML file) to CCD (XML file)
 * All CCDA files which are supposed to be Converted should be outside 'src' folder
 * Saves the CCD file outside the 'src' folder
